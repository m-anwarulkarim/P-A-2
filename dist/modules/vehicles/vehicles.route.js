...
router.get("/", auth(role.admin, role.customer), vehiclesController.getAllVehicles);
router.get("/:id", auth(role.admin, role.customer), vehiclesController.getSingelVehicles);
